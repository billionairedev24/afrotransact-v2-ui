    ...
    <SellBandClientGate>
      <section className="max-w-page mx-auto px-4 sm:px-5">
        <Link
          ...
          className="group flex items-center justify-between gap-3 rounded-lg border border-border bg-card hover:bg-muted px-4 sm:px-6 py-3 transition-colors"
        >
          ...
          <span className="shrink-0 inline-flex items-center gap-1 text-sm font-semibold text-foreground group-hover:text-orange-600">
            Start selling
