...
/**
 * Wishlist section for the account hub — server is the source of truth (#43).
 *
  ...
  if (ids.length === 0) {
    return (
      <div className="rounded-2xl border border-border bg-card px-6 py-16 text-center">
        ...
        <h4 className="mt-4 text-sm font-semibold text-foreground">Your wishlist is empty</h4>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {items.map((item) => (
          <article key={item.productId} className="rounded-2xl border border-border bg-card overflow-hidden hover:shadow-md transition-shadow">
