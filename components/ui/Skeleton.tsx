...
export function OrderCardSkeleton() {
  return (
    <div className="rounded-2xl border border-gray-200 bg-white overflow-hidden">
      <div className="px-4 sm:px-5 py-3 border-b border-gray-200 bg-gray-50 flex justify-between">
      ...
      {[1, 2].map((k) => (
        <div key={k} className="flex items-center gap-4 px-4 sm:px-5 py-4 border-b border-gray-100">
