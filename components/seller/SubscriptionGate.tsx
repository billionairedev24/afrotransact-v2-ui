  ...
  return (
    <div className="flex flex-col items-center justify-center px-4 py-16 text-center">
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <Link
                ...
                className="mt-6 block rounded-xl bg-brand-gold px-4 py-2.5 text-center text-sm font-semibold text-[#0f0f10] hover:bg-brand-gold-hover transition-colors"
              >
                Get Started
              </Link>
            </div>
      ...
      {plans.length === 0 && (
        <Link
          href="/dashboard/subscription"
          className="mt-8 inline-flex items-center gap-2 rounded-xl bg-brand-gold px-6 py-3 text-sm font-bold text-[#0f0f10] hover:bg-brand-gold-hover transition-colors"
        >
