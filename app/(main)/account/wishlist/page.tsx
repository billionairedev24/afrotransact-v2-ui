...
export default function WishlistPage() {
  ...
  if (status !== "authenticated") {
    return (
      <main className="mx-auto max-w-3xl px-4 sm:px-6 py-20 text-center">
        ...
        <h1 className="text-xl font-bold text-white mt-5">Sign in to view your wishlist</h1>
        <Link
          href="/auth/login"
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 sm:px-6 py-8">
      <h1 className="text-2xl font-bold text-white mb-6">Your Wishlist</h1>

      <div className="rounded-2xl border border-white/[0.08] px-6 py-16 text-center" style={{ background: "hsl(0 0% 11%)" }}>
        <Heart className="mx-auto h-14 w-14 text-gray-600" />
        <h2 className="text-lg font-semibold text-white mt-5">Your wishlist is empty</h2>
