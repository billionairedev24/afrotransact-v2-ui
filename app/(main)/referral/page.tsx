...
export default function ReferralPage() {
  return (
    <main className="mx-auto max-w-2xl px-4 sm:px-6 py-16 text-center">
      ...
      <h1 className="text-3xl font-black text-white">Refer a Friend</h1>
      ...
      <div className="mt-8 rounded-2xl border border-white/10 bg-card p-6 space-y-4">
        ...
        <div className="flex items-center gap-2 rounded-xl border border-white/15 bg-white/5 px-4 py-3">
          <span className="flex-1 text-sm text-white text-left truncate">https://afrotransact.com/r/YOUR_CODE</span>
