    ...
    <main className="mx-auto max-w-2xl px-4 sm:px-6 py-16 text-center">
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 text-left">
        {[
          ...
          { icon: <ChevronRight className="h-5 w-5 text-foreground" />, step: "3", title: "You both get $5", desc: "$5 credit is added to both accounts after the order is delivered." },
        ].map((item) => (
      ...
      <div className="mt-8">
        <Link href="/auth/login" className="inline-flex h-11 items-center gap-2 rounded-xl bg-brand-gold px-8 text-sm font-bold text-brand-gold-foreground hover:bg-brand-gold/90 transition-all">
