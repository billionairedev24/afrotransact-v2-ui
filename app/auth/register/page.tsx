    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center px-4 sm:px-8 lg:px-16 py-12 bg-background">
        ...
        <div className="w-full max-w-[420px] mx-auto space-y-8">
          ...
          {/* Social registration buttons — Coming Soon */}
            ...
            <div className="group relative">
              ...
              >
                <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none">
                  ...
                  <rect x="2" y="2" width="20" height="20" rx="5" stroke="url(#ig-register)" strokeWidth="2" />
                  <circle cx="12" cy="12" r="5" stroke="url(#ig-register)" strokeWidth="2" />
                  <circle cx="18" cy="6" r="1.5" fill="url(#ig-register)" />
                </svg>
