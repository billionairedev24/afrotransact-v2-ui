    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Create and manage discount coupons for your products.</p>
        </div>
        <button
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="divide-y divide-white/5">
              {loading ? (
                <tr><td colSpan={8} className="px-4 py-16 text-center"><Loader2 className="h-5 w-5 animate-spin text-gray-500 mx-auto" /></td></tr>
              ) : coupons.length === 0 ? (
                <tr>
                ...
                coupons.map(c => (
                  <tr key={c.id} className="hover:bg-white/[0.02] transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <span className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${c.active ? "bg-emerald-500/15 text-emerald-400" : "bg-gray-500/15 text-gray-400"}`}>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1">
                        ...
                        <button onClick={() => handleDelete(c.id)} className="rounded-lg p-1.5 text-gray-400 hover:text-red-400 hover:bg-red-500/5 transition-colors">
...
function CouponForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-xl border border-white/5 p-6 space-y-4" style={{ background: "hsl(0 0% 11%)" }}>
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-semibold text-white">{coupon ? "Edit Coupon" : "Create Coupon"}</h3>
