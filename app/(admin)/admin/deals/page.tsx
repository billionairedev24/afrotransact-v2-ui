...
const EMPTY_FORM: PlatformDealCreateRequest = {
  ...
  primaryColor: "#F5C518", secondaryColor: "#1a1a1a", textColor: "#ffffff",
              ...
              <div className="grid grid-cols-3 gap-3 mt-1">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    <input type="color" value={form.primaryColor || "#F5C518"} onChange={e => setForm({ ...form, primaryColor: e.target.value })} className="h-8 w-8 rounded border border-gray-300 cursor-pointer" />
                    <input value={form.primaryColor || "#F5C518"} onChange={e => setForm({ ...form, primaryColor: e.target.value })} className="flex-1 rounded-lg border border-gray-300 px-2 py-1 text-xs outline-none" />
                  </div>
                </div>
                <div>
